...
- 👨‍👩‍👧 **Parent account support** — Dedicated tabs: **Documents** (family docs by category), **Financial overview** (Invoices, Wallet, Payment method), **School life** (Enrollment dossier, Surveys); child-account selector to view a pupil's timetable, grades, and homework
